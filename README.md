...
**DEPI Capstone Project - Top Project Award**

<img src="https://user-images.githubusercontent.com/74038190/212257472-08e52665-c503-4bd9-aa20-f5a4dae769b5.gif" width="100">

Architected and deployed complete Azure infrastructure for enterprise web application including:
- Azure VMs
- Virtual Networks
- Load Balancers
...
**Project selected as top project in track and presented to Ministry of ICT officials**
...
Deployed scalable e-commerce application on Azure infrastructure:
...
Built automated deployment pipeline on AWS infrastructure:
- Custom VPC with security groups
- EKS cluster with 2 worker nodes
- Jenkins as Kubernetes pod
- GitHub webhook integration for automated builds
- CI pipeline for Docker image creation and push to DockerHub
- Applications deployed to separate namespace with continuous deployment automation
